...
const RegionalMapOverview = dynamic(
  () =>
    import("@/features/telemetry/RegionalMapOverview").then((m) => ({
      default: m.RegionalMapOverview,
    })),
  {
    ssr: false,
    loading: () => (
...
export function RegionalMapOverviewLoader() {
  return <RegionalMapOverview />;
}